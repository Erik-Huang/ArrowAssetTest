...
namespace Microsoft.MixedReality.Toolkit.Utilities
{
    ...
    /// </summary>
    [AddComponentMenu("Scripts/MRTK/Core/TriangleLineDataProvider")]
    public class TriangleLineDataProvider : BaseMixedRealityLineDataProvider
    {
        [SerializeField]
        ...
        private void BuildPoints()
        {
            ...
            SetPointInternal(1, right + offset);
            //SetPointInternal(4, bot + right + offset);
            //SetPointInternal(5, bot + offset);
            SetPointInternal(2, bot + left + offset);
            SetPointInternal(3, left + offset);
        }
    }
}